...
import com.tao.agent.problemResolvedAgent;
...
public class ProblemResolvedTool {

    private final problemResolvedAgent resolvedAgent;
    ...
    public String validateResolved(String info, String validAnswersJson) {
        ...
        try {
            ...
            for (JsonNode obj : root) {
                ...
                // 调用 LLM 判断是否解决问题
                String resolvedResult = resolvedAgent.isProblemResolved(
